...
| **Index** | **Requirement specification** | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPA_01 | The Wallet Unit used by a User, as well as the Relying Party Instance used by the Relying Party, SHALL implement a mechanism for Relying Party authentication in PID or attestation presentation transactions. This mechanism SHALL: - enable the Wallet Unit to identify and authenticate the Relying Party, - enable the Wallet Unit to verify that the request from the Relying Party was not copied and replayed, - use an access certificate issued in accordance with [[Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties)]. |       Keep        | Kukrukasutaja kasutatav kukrukomplekt, samuti kukrule tugineva isiku kasutatav tugineva osapoole instants, PEAB rakendama tugineva osapoole autentimise mehhanismi PID või atesteeringu esitamise tehingutes. See mehhanism PEAB: - võimaldama kukrukomplektil tuvastada ja autentida kukrule tuginevat isikut, - võimaldama kukrukomplektil kontrollida, et kukrule tugineva isiku päringut ei ole kopeeritud ja uuesti esitatud, - kasutama juurdepääsusertifikaati, mis on välja antud vastavalt [[Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties)]. |
| RPA_01a | If a Wallet Unit supports the [W3C Digital Credentials API] for remote presentation flows, it SHALL retain full authority over the process meant in RPA_01. In particular, this process SHALL NOT be handled by a third party, including the browser and the operating system. |        Keep       | Kui kukrukomplekt toetab [W3C Digital Credentials API] kaugveebi esitamise voogude jaoks, PEAB ta säilitama täieliku volituse RPA_01 kirjeldatud protsessi üle. Eelkõige EI TOHI seda protsessi käsitleda kolmas osapool, sealhulgas brauser ja operatsioonisüsteem. |
| RPA_02 | For performing Relying Party authentication, Wallet Units and Relying Party Instances SHALL support access certificates as specified in ETSI TS 119 475 and ETSI TS 119 411-8. _Note: In [ISO/IEC 18013-5], the Relying Party authentication mechanism is called mdoc reader authentication and uses an X.509 certificate. For [OpenID4VP], [HAIP] specifies that Client Identifier Prefix ``x509_hash`` must be used to authenticate the Relying Party; this also uses an X.509 certificate._ |     Keep          | Tugineva osapoole autentimise läbiviimiseks PEAVAD kukrukomplektid ja tugineva osapoole instantsid toetama juurdepääsusertifikaate, nagu on määratletud standardites ETSI TS 119 475 ja ETSI TS 119 411-8. _Märkus: [ISO/IEC 18013-5] kohaselt nimetatakse tugineva osapoole autentimise mehhanismi mdoc-lugeja autentimiseks ja see kasutab X.509 sertifikaati. [OpenID4VP] puhul määrab [HAIP], et kukrule tugineva isiku autentimiseks tuleb kasutada kliendi identifikaatori eesliidet `x509_hash`; ka see kasutab X.509 sertifikaati._ |
| RPA_02a | Empty |    Keep           | Tühi |
| RPA_03 | A Wallet Unit and a Relying Party Instance SHALL perform Relying Party authentication in all PID or attestation presentation transactions to Relying Parties, whether proximity or remote, using an access certificate. _Note: The actions both entities perform differ. For example, while the Relying Party creates a signature over some data in the request, the Wallet Unit validates that signature._ |    Keep           | Kukrukomplekt ja tugineva osapoole instants PEAVAD teostama tugineva osapoole autentimise kõigis PID või atesteeringu esitamise tehingutes kukrule tuginevatele isikutele, olenemata sellest, kas tegemist on lähi- või kaugtehinguga, kasutades juurdepääsusertifikaati. _Märkus: Mõlema üksuse sooritatavad toimingud erinevad. Näiteks, samal ajal kui kukrule tuginev isik loob päringus olevate andmete kohta allkirja, valideerib kukrukomplekt selle allkirja._ |
| RPA_04 | For the verification of access certificates, a Wallet Unit SHALL accept the trust anchors in the LoTE(s) of all Access Certificate Authorities notified by Member States. _Note: For more information about Access Certificate Authorities, please see [[Topic 31](./annex-2.02-high-level-requirements-by-topic.md#a2320-topic-31---notification-and-publication-of-pid-provider-wallet-provider-attestation-provider-access-certificate-authority-and-provider-of-registration-certificates)]._ |       Keep        | Juurdepääsusertifikaatide kontrollimiseks PEAB kukrukomplekt aktsepteerima liikmesriikide poolt teavitatud kõigi juurdepääsusertifikaatide asutuste LoTE(de) usaldusankruid. _Märkus: Lisateavet juurdepääsusertifikaatide asutuste kohta vt [[Topic 31](./annex-2.02-high-level-requirements-by-topic.md#a2320-topic-31---notification-and-publication-of-pid-provider-wallet-provider-attestation-provider-access-certificate-authority-and-provider-of-registration-certificates)]._ |
| RPA_05 | If Relying Party authentication fails for any reason, the Wallet Instance SHALL inform the User that the identity of the Relying Party could not be verified and that therefore the request is not trustworthy. |    Keep           | Kui tugineva osapoole autentimine mingil põhjusel ebaõnnestub, PEAB kukrueksemplar teavitama kukrukasutajat, et kukrule tugineva isiku identiteeti ei saanud kontrollida ja seetõttu pole päring usaldusväärne. |
| RPA_06 | If Relying Party authentication succeeds, the Wallet Instance SHALL display to the User the **trade** name of the Relying Party **'s Relying Party Service** as included in the access certificate received from the Relying Party Instance, together with the attributes requested by the Relying Party. The Wallet Instance SHALL do so when asking the User for approval according to RPA_07. _Notes: **a) A Relying Party Instance may be used for multiple Relying Party services, provided it has received a separate access certificate for each, see Reg_10b. b)** If the Relying Party is an intermediary acting on behalf of an intermediated Relying Party, the Wallet Instance displays the **trade** names of both the intermediary **'s Service** and the intermediated Relying Party **'s Service** to the User, see RPI_07._ |    **Modify**           | Kui tugineva osapoole autentimine õnnestub, PEAB kukrueksemplar kuvama kukrukasutajale kukrule tugineva isiku **kukrule tugineva isiku teenuse ärinime**, nagu see sisaldub tugineva osapoole instantsilt saadud juurdepääsusertifikaadis, koos kukrule tugineva isiku poolt taotletud atribuutidega. Kukrueksemplar PEAB seda tegema, kui ta küsib kukrukasutajalt heakskiitu vastavalt RPA_07. _Märkused: **a) Tugineva osapoole instantsi võib kasutada mitme kukrule tugineva isiku teenuse jaoks, tingimusel et ta on saanud igaühe jaoks eraldi juurdepääsusertifikaadi, vt Reg_10b. b)** Kui kukrule tuginev isik on vahendaja, kes tegutseb vahendatava kukrule tugineva isiku nimel, kuvab kukrueksemplar kukrukasutajale nii vahendaja **teenuse** kui ka vahendatava kukrule tugineva isiku **teenuse ärinimed**, vt RPI_07._ |
| RPA_06a | If Relying Party authentication fails for any reason, the Wallet Unit SHALL notify the User. In addition, the Wallet Unit SHALL either not present the requested attributes to the Relying Party, or give the User the choice to present the requested attributes or not. _Note: It is up to the Wallet Provider to make a choice for one of these two options._ |       Keep        | Kui tugineva osapoole autentimine mingil põhjusel ebaõnnestub, PEAB kukrukomplekt sellest kukrukasutajat teavitama. Lisaks PEAB kukrukomplekt kas mitte esitama taotletud atribuute kukrule tuginevale isikule või andma kukrukasutajale võimaluse valida, kas esitada taotletud atribuute või mitte. _Märkus: Kukruteenuse pakkuja ülesanne on teha valik ühe neist kahest võimalusest._ |
...
| **Index** | **Requirement specification** | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_01 | Member States SHALL provide processes and mechanisms for PID Providers, QEAA Providers, PuB-EAA Providers, non-qualified EAA Providers, and Relying Parties to register in a registry. _Note: Member States may choose to implement a single registry for all these roles, or a separate registry for each of these roles._ |       Keep        | Liikmesriigid PEAVAD pakkuma PID-i pakkujatele, QEAA pakkujatele, PuB-EAA pakkujatele, mittekvalifitseeritud EAA pakkujatele ja kukrule tuginevatele isikutele protsesse ja mehhanisme registrisse registreerimiseks. _Märkus: Liikmesriigid võivad otsustada rakendada nende kõigi rollide jaoks ühtset registrit või iga sellise rolli jaoks eraldi registrit._ |
| Reg_01a | Member States SHALL register a common set of data about a) PID Providers, b) QEAA Providers, c) PuB-EAA Providers, d) non-qualified EAA Providers. and e) Relying Parties, according to the relevant requirements in [Technical Specification 6](../../technical-specifications/ts6-common-set-of-rp-information-to-be-registered.md). _Note: For PID Providers, QEAA Providers, PuB-EAA Providers, and non-qualified EAA Providers, the common set of data specified in [Technical Specification 6] include the attestation type(s) that the provider intends to issue to Wallet Units._ | Keep | Liikmesriigid PEAVAD registreerima ühise andmekogumi kohta a) PID-i pakkujad, b) QEAA pakkujad, c) PuB-EAA pakkujad, d) mittekvalifitseeritud EAA pakkujad. ja e) kukrule tuginevad isikud vastavalt asjakohastele nõuetele dokumendis [Tehniline spetsifikatsioon 6](../../technical-specifications/ts6-common-set-of-rp-information-to-be-registered.md). _Märkus: PID-i pakkujate, QEAA pakkujate, PuB-EAA pakkujate ja mittekvalifitseeritud EAA pakkujate puhul sisaldab dokumendis [Tehniline spetsifikatsioon 6] määratletud ühine andmekogum atesteerimise tüüpi (tüüpe), mida pakkuja kavatseb kukrukomplektidele väljastada._ |
| Reg_01b | Empty |       -        | Tühi |
| Reg_02 | Member States SHALL make publicly available all necessary details and documentation about the registration processes for their registry. |       Keep        | Liikmesriigid PEAVAD tegema üldsusele kättesaadavaks kõik vajalikud üksikasjad ja dokumentatsiooni oma registri registreerimisprotsesside kohta. |
| Reg_03 | Member States SHALL publish the registry entries online, in a sealed or signed machine-readable common format suitable for automated processing, according to the relevant requirements in [Technical Specification 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md), for the purpose of transparency to Users and other stakeholders. |       Keep        | Liikmesriigid PEAVAD avaldama registrikanded veebis pitseeritud või allkirjastatud masinloetavas ühtses vormingus, mis sobib automatiseeritud töötlemiseks, vastavalt asjakohastele nõuetele dokumendis [Tehniline spetsifikatsioon 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md), et tagada läbipaistvus kukrukasutajatele ja teistele sidusrühmadele. |
| Reg_04 | Member States SHALL make the registry entries available online, in a human-readable format. The website used for this purpose SHALL use a secure channel protecting the authenticity and integrity of the information in the registry during transport. Member States SHALL NOT require authentication or prior registration and authorisation of any person wishing to retrieve the information in the registry. |       Keep        | Liikmesriigid PEAVAD tegema registrikanded veebis inimloetavas vormingus kättesaadavaks. Selleks kasutatav veebisait PEAB kasutama turvalist kanalit, mis kaitseb registris oleva teabe autentsust ja terviklikkust transpordi ajal. Liikmesriigid EI TOHI nõuda autentimist ega eelnevat registreerimist ja volitamist üheltki isikult, kes soovib registrist teavet hankida. |
| Reg_05 | Empty |       -        | Tühi |
| Reg_06 | Member States SHALL support the common API specified in [Technical Specification 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md) ~~for~~ to enable automated retrieval of registry entries from the Member States' registries. _Note: [Technical Specification 5] specifies the use of a secure channel protecting the authenticity and integrity of the information in the registry during transport, and does not require authentication or prior registration and authorisation of any entity wishing to retrieve the information in the registry._ |   **Modify**   | Liikmesriigid PEAVAD toetama dokumendis [Tehniline spetsifikatsioon 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md) määratletud ühtset API-t, et võimaldada registrikannete automatiseeritud hankimist liikmesriikide registritest. _Märkus: [Tehniline spetsifikatsioon 5] määrab kindlaks turvalise kanali kasutamise, mis kaitseb registris oleva teabe autentsust ja terviklikkust transpordi ajal, ega nõua autentimist ega eelnevat registreerimist ja volitamist üheltki üksuselt, kes soovib registrist teavet hankida._ |
| Reg_07 | A Member State SHALL enable a registered PID Provider, QEAA Provider, PuB-EAA Provider, non-qualified EAA Provider, or Relying Party to update the information registered on it, using a process comparable to the original registration process. For Relying Parties, this SHALL be possible using the API or user interface mentioned in Reg_24. |    Keep   | Liikmesriik PEAB võimaldama registreeritud PID-i pakkujal, QEAA pakkujal, PuB-EAA pakkujal, mittekvalifitseeritud EAA pakkujal või kukrule tugineval isikul ajakohastada tema kohta registreeritud teavet, kasutades algse registreerimisprotsessiga võrreldavat protsessi. Kukrule tuginevate isikute jaoks PEAB see olema võimalik, kasutades punktis Reg_24 mainitud API-t või kasutajaliidest. |
| Reg_08 | A registered PID Provider, QEAA Provider, PuB-EAA Provider, non-qualified EAA Provider, or Relying Party SHALL make any updates necessary to ensure the continued correctness of the registered information without undue delay. | Keep   | Registreeritud PID-i pakkuja, QEAA pakkuja, PuB-EAA pakkuja, mittekvalifitseeritud EAA pakkuja või kukrule tuginev isik PEAB viivitamata tegema kõik vajalikud uuendused, et tagada registreeritud teabe pidev õigsus. |
| Reg_09 | Member States SHALL log all changes made on the information registered regarding a PID Provider, QEAA Provider, PuB-EAA Provider, non-qualified EAA Provider, or Relying Party, including at least initial registration, updates, deletion of information, and suspension or cancellation. |       Keep        | Liikmesriigid PEAVAD logima kõik PID-i pakkuja, QEAA pakkuja, PuB-EAA pakkuja, mittekvalifitseeritud EAA pakkuja või kukrule tugineva isiku kohta registreeritud teabes tehtud muudatused, sealhulgas vähemalt esialgse registreerimise, uuendused, teabe kustutamise ning peatamise või tühistamise. |

B. _General requirements for the issuance of access certificates_

| **Index** | **Requirement specification**                                | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_10    | A Member State SHALL ensure that an Access Certificate Authority notified according to [[Topic 31](./annex-2.02-high-level-requirements-by-topic.md#a2320-topic-31---notification-and-publication-of-pid-provider-wallet-provider-attestation-provider-access-certificate-authority-and-provider-of-registration-certificates)] issues **one or more** access certificate**s** to all PID Providers, QEAA Providers, PuB-EAA Providers, non-qualified EAA Providers **and Relying Parties** registered in one of the Member State's registries. **_Note: To be able to authenticate towards Wallet Units, each Relying Party Instance of a Relying Party and each service supply point of a PID Provider or Attestation Provider needs a separate access certificate, where the private key corresponding to the public key in the certificate is managed in the RPI's or service supply point's hardware and software._** | Modified, merged existing Reg_10a into Reg_10, since also PID Providers and Attestation Providers may have multiple Relying Party Instances. Moreover, that each RPI receives a separate access certificate is a technical necessity, not a requirement; this is now explained now in a note. | Liikmesriik PEAB tagama, et vastavalt teemale [[Topic 31](./annex-2.02-high-level-requirements-by-topic.md#a2320-topic-31---notification-and-publication-of-pid-provider-wallet-provider-attestation-provider-access-certificate-authority-and-provider-of-registration-certificates)] teavitatud juurdepääsusertifikaatide asutus väljastab **ühe või mitu** juurdepääsusertifikaati kõigile liikmesriigi ühes registris registreeritud PID-i pakkujatele, QEAA pakkujatele, PuB-EAA pakkujatele, mittekvalifitseeritud EAA pakkujatele **ja kukrule tuginevatele isikutele**. **_Märkus: Kukrukomplektide ees autentimiseks vajab kukrule tugineva isiku iga tugineva osapoole instants ning PID-i pakkuja või atesteerimisteenuse pakkuja iga teenuse pakkumise punkt eraldi juurdepääsusertifikaati, mille sertifikaadis olevale avalikule võtmele vastavat privaatvõtit hallatakse RPI või teenuse pakkumise punkti riist- ja tarkvaras._** |
| Reg_10a    | ~~A Member State SHALL ensure that an Access Certificate Authority notified according to [[Topic 31]] issues one or more access certificates to all Relying Parties registered in one of the Member State's registries. A Relying Party SHALL receive a separate access certificate for each of its Relying Party Instances.~~ Empty | Deleted, see Reg_10 | Tühi |
| Reg_10b   | A registering entity SHALL register one or more Relying Party services, and SHALL receive at least one access certificate for each registered service, complying with Reg_33 and Reg_34. _Notes: a) If the registering entity registers only one service, all of its access certificates will contain an identical Service identifier and Service trade name. b) A single Relying Party Instance may receive multiple access certificates, corresponding to multiple services of the same Relying Party. This would enable the Relying Party to use the same RPI for multiple services._ | New | Registreeriv üksus PEAB registreerima ühe või mitu kukrule tugineva isiku teenust ning PEAB saama iga registreeritud teenuse kohta vähemalt ühe juurdepääsusertifikaadi, mis vastab punktidele Reg_33 ja Reg_34. _Märkused: a) Kui registreeriv üksus registreerib ainult ühe teenuse, sisaldavad kõik tema juurdepääsusertifikaadid identset teenuse identifikaatorit ja teenuse ärinime. b) Üks tugineva osapoole instants võib saada mitu juurdepääsusertifikaati, mis vastavad sama kukrule tugineva isiku mitmele teenusele. See võimaldaks kukrule tugineval isikul kasutada sama RPI-d mitme teenuse jaoks._ |
| Reg_10c   | If the Registrar decided that registration certificates must be issued (see RPRC_09 or RPRC_09a), the registering entity SHALL receive at least one registration certificate for each registered service, complying with RPRC_07a. _Note: If the registering entity registers only one service, all of its registration certificates will contain an identical Service identifier and Service trade name._ | New | Kui registripidaja otsustas, et registreerimissertifikaadid tuleb väljastada (vt RPRC_09 või RPRC_09a), PEAB registreeriv üksus saama iga registreeritud teenuse kohta vähemalt ühe registreerimissertifikaadi, mis vastab punktile RPRC_07a. _Märkus: Kui registreeriv üksus registreerib ainult ühe teenuse, sisaldavad kõik tema registreerimissertifikaadid identset teenuse identifikaatorit ja teenuse ärinime._ |
| Reg_10d   | A Relying Party SHALL register which of its registered intended uses are applicable to each of its registered services. _Note: Another way to phrase this is to say that the Relying Party must register the intended use(s) of each of it registered services separately._ | New - Note that this requirement must be included in TS5 / TS6. | Kukrule tuginev isik PEAB registreerima, millised tema registreeritud kavandatud kasutusotstarbed on kohaldatavad iga tema registreeritud teenuse suhtes. _Märkus: Teine viis selle sõnastamiseks on öelda, et kukrule tuginev isik peab registreerima iga oma registreeritud teenuse kavandatud kasutusotstarbe(d) eraldi._ |
| Reg_10e   | A PID Provider or Attestation Provider SHALL register which type(s) of attestation each of its registered services intends to issue to Wallet Units. | New - Note that this requirement must be included in TS5 / TS6. | PID-i pakkuja või atesteerimisteenuse pakkuja PEAB registreerima, millist tüüpi atesteeringuid iga tema registreeritud teenus kavatseb kukrukomplektidele väljastada. |
| Reg_11 | A Member State SHALL ensure that the issuance process of access certificates by their notified Access Certificate Authority(s) complies with ETSI TS 119 411-8. In addition, the Access Certificate Authority(s) SHALL comply with at least the normalised certificate policy (‘NCP’) requirements as specified in ETSI EN 319- 411-1. |       Keep        | Liikmesriik PEAB tagama, et tema teavitatud juurdepääsusertifikaatide asutus(t)e juurdepääsusertifikaatide väljastamise protsess vastab standardile ETSI TS 119 411-8. Lisaks PEAB/PEAVAD juurdepääsusertifikaatide asutus(ed) vastama vähemalt normaliseeritud sertifitseerimispoliitika ("NCP") nõuetele, nagu on määratletud standardis ETSI EN 319- 411-1. |
| Reg_12 | Empty |       -           | Tühi |
| Reg_13 | Empty |       -           | Tühi |
| Reg_14 | Empty |       -           | Tühi |
| Reg_15 | Empty |       -           | Tühi |
...
| **Index** | **Requirement specification**                                | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_19 | A Member State SHALL approve a PID Provider according to a well-defined policy before including it in its PID Provider Registry. To that end, a Member State SHALL define specific vetting processes and rules of acceptance for inclusion of PID Providers in its Registry. |       Keep        | Liikmesriik PEAB heaks kiitma PID-i pakkuja vastavalt selgelt määratletud poliitikale enne tema kandmist oma PID-i pakkujate registrisse. Sel eesmärgil PEAB liikmesriik määratlema konkreetsed kontrolliprotsessid ja aktsepteerimisreeglid PID-i pakkujate kaasamiseks oma registrisse. |
| Reg_20 | A Member State SHALL identify PID Providers at a level of confidence proportionate to the risk arising from the potential harm a fraudulent PID Provider could cause to Users and other stakeholders in the EUDI Wallet ecosystem. |       Keep        | Liikmesriik PEAB tuvastama PID-i pakkujaid usaldusväärsuse tasemel, mis on proportsionaalne riskiga, mis tuleneb võimalikust kahjust, mida petturlik PID-i pakkuja võiks põhjustada kukrukasutajatele ja teistele sidusrühmadele EUDI kukru ökosüsteemis. |
| Reg_20a | A Registrar SHALL provide a method to suspend or cancel a registered PID Provider. |       Keep        | Registripidaja PEAB pakkuma meetodi registreeritud PID-i pakkuja peatamiseks või tühistamiseks. |
| Reg_20b | A Registrar SHALL have a policy for the suspension or cancellation of a registered PID Provider, which SHALL specify that a PID Provider is suspended or cancelled at least on request of the PID Provider or of a competent national authority. |       Keep        | Registripidajal PEAB olema registreeritud PID-i pakkuja peatamise või tühistamise poliitika, mis PEAB sätestama, et PID-i pakkuja peatatakse või tühistatakse vähemalt PID-i pakkuja või pädeva siseriikliku asutuse taotlusel. |

D. _Requirements for the registration of Attestation Providers_

| **Index** | **Requirement specification**                                | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_21 | A Member State SHALL approve an Attestation Provider according to a well-defined policy before including it in its Attestation Provider Registry. To that end, a Member State SHALL define specific vetting processes and rules of acceptance for inclusion of Attestation Providers in its Registry. These processes and rules SHOULD consider any relevant differences between QEAA Providers, PuB-EAA Providers, and non-qualified EAA Providers. |       Keep        | Liikmesriik PEAB heaks kiitma atesteerimisteenuse pakkuja vastavalt selgelt määratletud poliitikale enne tema kandmist oma atesteerimisteenuse pakkujate registrisse. Sel eesmärgil PEAB liikmesriik määratlema konkreetsed kontrolliprotsessid ja aktsepteerimisreeglid atesteerimisteenuse pakkujate kaasamiseks oma registrisse. Need protsessid ja reeglid PEAKSID arvesse võtma kõiki asjakohaseid erinevusi QEAA pakkujate, PuB-EAA pakkujate ja mittekvalifitseeritud EAA pakkujate vahel. |
| Reg_22 | A Member State SHALL identify Attestation Providers (i.e., QEAA Providers, PuB-EAA Providers and non-qualified EAA Providers) at a level of confidence proportionate to the risk arising from the potential harm a fraudulent Attestation Provider could cause to Users and other stakeholders in the EUDI Wallet ecosystem. |       Keep        | Liikmesriik PEAB tuvastama atesteerimisteenuse pakkujaid (s.t QEAA pakkujaid, PuB-EAA pakkujaid ja mittekvalifitseeritud EAA pakkujaid) usaldusväärsuse tasemel, mis on proportsionaalne riskiga, mis tuleneb võimalikust kahjust, mida petturlik atesteerimisteenuse pakkuja võiks põhjustada kukrukasutajatele ja teistele sidusrühmadele EUDI kukru ökosüsteemis. |
| Reg_22a | A Registrar SHALL provide a method to suspend or cancel a registered Attestation Provider. |       Keep        | Registripidaja PEAB pakkuma meetodi registreeritud atesteerimisteenuse pakkuja peatamiseks või tühistamiseks. |
| Reg_22b | A Registrar SHALL have a policy for the suspension or cancellation of a registered Attestation Provider, which SHALL specify that an Attestation Provider is suspended or cancelled at least on request of the Attestation Provider or of a competent national authority. |       Keep        | Registripidajal PEAB olema registreeritud atesteerimisteenuse pakkuja peatamise või tühistamise poliitika, mis PEAB sätestama, et atesteerimisteenuse pakkuja peatatakse või tühistatakse vähemalt atesteerimisteenuse pakkuja või pädeva siseriikliku asutuse taotlusel. |
...
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_23 | Empty |       -        | Tühi |
| Reg_24 | A Member State SHALL enable a Relying Party to register remotely, using an API or user interface. |       Keep        | Liikmesriik PEAB võimaldama kukrule tugineval isikul registreeruda eemalt, kasutades API-t või kasutajaliidest. |
| Reg_25 | A Member State SHALL identify a Relying Party at a level of confidence proportionate to the risk arising from the potential harm a fraudulent Relying Party could cause to Users and other stakeholders in the EUDI Wallet ecosystem. |        Keep        | Liikmesriik PEAB tuvastama kukrule tugineva isiku usaldusväärsuse tasemel, mis on proportsionaalne riskiga, mis tuleneb võimalikust kahjust, mida petturlik kukrule tuginev isik võiks põhjustada kukrukasutajatele ja teistele sidusrühmadele EUDI kukru ökosüsteemis. |
| Reg_26 | With respect to Reg_25, a Member State SHALL consider whether a registering entity intends to act as an intermediary. _Note: According to the [European Digital Identity Regulation], an intermediary is a Relying Party._ |       Keep        | Seoses punktiga Reg_25 PEAB liikmesriik kaaluma, kas registreeriv üksus kavatseb tegutseda vahendajana. _Märkus: Vastavalt [Euroopa digitaalidentiteedi määrusele] on vahendaja kukrule tuginev isik._ |
| Reg_27 | Empty |       -        | Tühi |
| Reg_28 | Empty |       -        | Tühi |
| Reg_29 | A Member State SHALL have a policy for the cancellation of a registered Relying Party, which SHALL specify that a Relying Party is cancelled at least on request of the Relying Party or of a competent national authority. |       Keep        | Liikmesriigil PEAB olema registreeritud kukrule tugineva isiku tühistamise poliitika, mis PEAB sätestama, et kukrule tuginev isik tühistatakse vähemalt kukrule tugineva isiku või pädeva siseriikliku asutuse taotlusel. |
| Reg_30 | Empty |       -        | Tühi |
...
| **Index** | **Requirement specification**                                | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| Reg_31 | An access certificate SHALL contain a **trade** name for the PID Provider, QEAA Provider, PuB-EAA Provider, non-qualified EAA Provider, or Relying Party, in a format suitable for presenting to a User. |      **Modify**       | Juurdepääsusertifikaat PEAB sisaldama PID-i pakkuja, QEAA pakkuja, PuB-EAA pakkuja, mittekvalifitseeritud EAA pakkuja või kukrule tugineva isiku **ärinime** vormingus, mis sobib kukrukasutajale esitamiseks. |
| Reg_32 | An access certificate SHALL contain an EU-wide unique identifier for the entity (i.e., the PID Provider, QEAA Provider, PuB-EAA Provider, non-qualified EAA Provider, or Relying Party), which SHALL be identical to the identifier for the entity registered according to [TS6] and included in the entity's registration certificate(s) (if present) according to RPRC_07. | **Modify**; reword to be similar to Reg_31 and to reference TS6.       | Juurdepääsusertifikaat PEAB sisaldama üksuse (st PID-i pakkuja, QEAA pakkuja, PuB-EAA pakkuja, mittekvalifitseeritud EAA pakkuja või kukrule tugineva isiku) ELi-ülest unikaalset identifikaatorit, mis PEAB olema identne üksuse identifikaatoriga, mis on registreeritud vastavalt standardile [TS6] ja mis sisaldub üksuse registreerimissertifikaadi(de)s (kui need on olemas) vastavalt punktile RPRC_07. |
| Reg_32a | The trade name meant in Reg_31 and the identifier meant in Reg_32 SHALL be the same in all access certificates issued to a given entity. | New | Punktis Reg_31 nimetatud ärinimi ja punktis Reg_32 nimetatud identifikaator PEAVAD olema samad kõigis antud üksusele väljastatud juurdepääsusertifikaatides. |
| Reg_33    | An access certificate SHALL contain a Relying Party Service identifier, which SHALL be provided by the registering entity according to [TS5] and [TS6], and SHALL be unique within the scope of that entity. Moreover, it SHALL be included in the entity's registration certificate (if present) according to RPRC_07a. | New | Juurdepääsusertifikaat PEAB sisaldama kukrule tugineva isiku teenuse identifikaatorit, mille PEAB esitama registreeriv üksus vastavalt standarditele [TS5] ja [TS6] ning mis PEAB olema unikaalne selle üksuse ulatuses. Lisaks PEAB see sisalduma üksuse registreerimissertifikaadis (kui see on olemas) vastavalt punktile RPRC_07a. |
| Reg_34    | An access certificate SHALL contain a trade name for the Relying Party service, which SHALL be provided by the registering entity according to [TS5] and [TS6], and SHALL be suitable for presenting to a User. | New | Juurdepääsusertifikaat PEAB sisaldama kukrule tugineva isiku teenuse ärinime, mille PEAB esitama registreeriv üksus vastavalt standarditele [TS5] ja [TS6] ning mis PEAB sobima kukrukasutajale esitamiseks. |
| Reg_35  | The access certificate format SHALL provide for the data elements to carry the Relying Party Service identifier mentioned in Reg_33 and the user-friendly Relying Party Service trade name mentioned in Reg_34. _Note: The generic X.509 certificate structure has multiple suitable data elements which could be designated for this use. As the RPAC specification is owned by ETSI by the time of handling this question, the EC will forward the question on fixing the exact element to the standardisation organisation._ | New | Juurdepääsusertifikaadi vorming PEAB ette nägema andmeelemendid, mis kannavad punktis Reg_33 nimetatud kukrule tugineva isiku teenuse identifikaatorit ja punktis Reg_34 nimetatud kasutajasõbralikku kukrule tugineva isiku teenuse ärinime. _Märkus: Üldisel X.509 sertifikaadi struktuuril on mitu sobivat andmeelementi, mida võiks selleks otstarbeks määrata. Kuna RPAC spetsifikatsioon kuulub selle küsimuse käsitlemise ajal ETSI-le, edastab Euroopa Komisjon küsimuse täpse elemendi fikseerimise kohta standardiorganisatsioonile._ |
...
| **Index** | **Requirement specification** | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPRC_01 | Providers of registration certificates SHALL comply with all relevant requirements in ETSI TS 119 475. |        Keep        | Registreerimissertifikaatide pakkujad PEAVAD vastama kõigile asjakohastele nõuetele standardis ETSI TS 119 475. |
| RPRC_02 | Empty |      Keep        | Tühi |
| RPRC_03 | The contents of a registration certificate SHALL include at least the information required in Annex V of the [CIR 2025/848](https://data.europa.eu/eli/reg_impl/2025/848/oj) regarding registration of wallet-relying parties. |      Keep        | Registreerimissertifikaadi sisu PEAB sisaldama vähemalt [CIR 2025/848](https://data.europa.eu/eli/reg_impl/2025/848/oj) V lisas nõutavat teavet kukrule tuginevate isikute registreerimise kohta. |
| RPRC_04     | If the subject of the registration certificate uses the services of an intermediary (see [Topic 52]), the 'association to the intermediary' mentioned in Annex I (15) of [CIR 2025/848] SHALL consist of the ~~user-friendly name and~~ unique identifier of this intermediary, as meant in requirement~~s~~ Reg_31 ~~and Reg_32,~~ **and the intermediary's Relying Party Service identifier as meant in Reg_33**.  _Note: ~~This~~**These** identifier**s** are identical to those in the access certificate of the intermediary._  | **Modify** by adding Relying Party Service identifier and removing Relying Party trade name. The trade name is not necessary for matching the intermediated RP to the intermediary. | Kui registreerimissertifikaadi subjekt kasutab vahendaja teenuseid (vt [Topic 52]), PEAB [CIR 2025/848] I lisa punktis 15 mainitud 'seos vahendajaga' koosnema selle vahendaja unikaalsest identifikaatorist, nagu on mõeldud nõudes Reg_31, **ja vahendaja kukrule tugineva isiku teenuse identifikaatorist, nagu on mõeldud punktis Reg_33**. _Märkus: **Need** identifikaator**id** on identsed vahendaja juurdepääsusertifikaadis olevatega._ |
| RPRC_04a    | The registration certificate format SHALL provide for the data elements to carry the Relying Party Service identifier mentioned in Reg_33 and the Relying Party Service trade name mentioned in Reg_34. _Note: The Commission will request ETSI to specify these additional claims in JSON and CBOR._ |  New | Registreerimissertifikaadi vorming PEAB ette nägema andmeelemendid, mis kannavad punktis Reg_33 nimetatud kukrule tugineva isiku teenuse identifikaatorit ja punktis Reg_34 nimetatud kukrule tugineva isiku teenuse ärinime. _Märkus: Komisjon palub ETSI-l täpsustada need täiendavad väited JSON-is ja CBOR-is._ |
| RPRC_05 | If the subject of the registration certificate is not a Relying Party (i.e. in the terms of CIR 2025/848, a Service Provider), the certificate SHALL NOT contain the intended use as meant in Annex I (9) and (10) of CIR 2025/848. _Note: A PID Provider or Attestation Provider may request attributes from the Wallet Unit during issuance. If so, it registers as both a Service Provider and an Attestation Provider, and consequently its registration certificate contains its intended use._ |      Keep        | Kui registreerimissertifikaadi subjekt ei ole kukrule tuginev isik (st CIR 2025/848 mõistes teenusepakkuja), EI TOHI sertifikaat sisaldada kavandatud kasutusotstarvet, nagu on mõeldud CIR 2025/848 I lisa punktides 9 ja 10. _Märkus: PID-i pakkuja või atesteerimisteenuse pakkuja võib väljastamise ajal taotleda kukrukomplektilt atribuute. Sellisel juhul registreerib ta end nii teenusepakkuja kui ka atesteerimisteenuse pakkujana ning seetõttu sisaldab tema registreerimissertifikaat tema kavandatud kasutusotstarvet._ |
| RPRC_06     | The contents of a registration certificate SHALL include a name for the subject of the certificate, in a format suitable for presenting to a User **, which SHALL be identical to the trade name in the access certificates of the entity, see Reg_31**. ~~Notes: _b) This name is identical to the name in the access certificate(s) of the entity, see Reg_31._~~. | **Modify** by moving note b) into the requirement itself for more clarity. | Registreerimissertifikaadi sisu PEAB sisaldama sertifikaadi subjekti nime vormingus, mis sobib kukrukasutajale esitamiseks**, mis PEAB olema identne üksuse juurdepääsusertifikaatides oleva ärinimega, vt Reg_31**. |
| RPRC_07     | The contents of a registration certificate SHALL include an EU-wide unique identifier for the subject of the certificate **, which SHALL be identical to the identifier in the access certificates of that entity, see Reg_32**. ~~_Notes: c) This identifier is identical to the identifier in the access certificate(s) of the entity, see Reg_32.~~_ | **Modify** by moving note c) into the requirement itself for more clarity. Also, we will delete note b, which is superfluous. | Registreerimissertifikaadi sisu PEAB sisaldama ELi-ülest unikaalset identifikaatorit sertifikaadi subjektile**, mis PEAB olema identne selle üksuse juurdepääsusertifikaatides oleva identifikaatoriga, vt Reg_32**. |
| RPRC_07a    |  The contents of a registration certificate SHALL contain an identifier and a name for the Relying Party service, which SHALL be identical to the service identifier and user-friendly name in one or more of the access certificates of that entity, see Reg_33 and Reg_34. _**Note: There must be at least one Relying Party Instance or service supply point that is able to use a given registration certificate.**_| New | Registreerimissertifikaadi sisu PEAB sisaldama kukrule tugineva isiku teenuse identifikaatorit ja nime, mis PEAVAD olema identsed selle üksuse ühes või mitmes juurdepääsusertifikaadis oleva teenuse identifikaatori ja kasutajasõbraliku nimega, vt Reg_33 ja Reg_34. _**Märkus: Peab olema vähemalt üks tugineva osapoole instants või teenuse pakkumise punkt, mis on võimeline kasutama antud registreerimissertifikaati.**_ |
| RPRC_08 | The EU-wide unique identifier meant in RPRC_07 SHALL be identical in all registration certificates issued for a given entity. _Note: In case the registration certificates issued to an intermediated Relying Party are held and presented by an intermediary, the entity meant in this requirement is the intermediated Relying Party. An intermediary may obtain and hold registration certificates with a different unique identifier for other intermediated Relying Parties._ |      Keep        | Punktis RPRC_07 nimetatud ELi-ülene unikaalne identifikaator PEAB olema identne kõigis antud üksusele väljastatud registreerimissertifikaatides. _Märkus: Juhul, kui vahendatavale kukrule tuginevale isikule väljastatud registreerimissertifikaate omab ja esitab vahendaja, on selles nõudes mõeldud üksus vahendatav kukrule tuginev isik. Vahendaja võib hankida ja omada teiste unikaalsete identifikaatoritega registreerimissertifikaate teistele vahendatavatele kukrule tuginevatele isikutele._ |

#### B Requirements on the issuance of registration certificates to Relying Parties

| **Index** | **Requirement specification** |**Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPRC_09    | A Member State Registrar MAY decide that, during the registration process for Relying Parties, as specified in [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), a Provider of registration certificates associated to the Registrar must create and sign or seal one or more registration certificates. If the Registrar decides to do so, the Provider of registration certificates SHALL create and sign or seal a separate registration certificate for each **combination of** intended use **and Relying Party service, as registered by the Relying Party per Reg_10d,** and issue it to the Relying Party. Each registration certificate SHALL comply with the requirements in the technical specification mentioned in RPRC_0~~2~~**1**. | **Modify** to take Relying Party services into consideration | Liikmesriigi registripidaja VÕIB otsustada, et kukrule tuginevate isikute registreerimisprotsessi käigus, nagu on määratletud dokumendis [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), peab registripidajaga seotud registreerimissertifikaatide pakkuja looma ja allkirjastama või pitseerima ühe või mitu registreerimissertifikaati. Kui registripidaja nii otsustab, PEAB registreerimissertifikaatide pakkuja looma ja allkirjastama või pitseerima eraldi registreerimissertifikaadi iga **kavandatud kasutusotstarbe ja kukrule tugineva isiku teenuse kombinatsiooni kohta, nagu kukrule tuginev isik on registreerinud vastavalt punktile Reg_10d,** ning väljastama selle kukrule tuginevale isikule. Iga registreerimissertifikaat PEAB vastama punktis RPRC_01 mainitud tehnilises spetsifikatsioonis esitatud nõuetele. |
| RPRC_10 | If, during registration, a Relying Party received one or more registration certificates, it SHALL distribute these to all ~~its~~ Relying Party Instances having an access certificate containing the same Relying Party Service identifier. | **Modify** to take Relying Party services into consideration | Kui kukrule tuginev isik sai registreerimise käigus ühe või mitu registreerimissertifikaati, PEAB ta need jaotama kõigile tugineva osapoole instantsidele, millel on juurdepääsusertifikaat, mis sisaldab sama kukrule tugineva isiku teenuse identifikaatorit. |
| RPRC_11 | The contents of a registration certificate issued to a Relying Party SHALL **contain** at least one of the following: a) the URL of a web form provided by the Relying Party, which Users can use to send data deletion requests, b) an e-mail address of the Relying Party, on which the Relying Party is prepared to receive data deletion requests from Users, c) a telephone number of the Relying Party, on which the Relying Party is prepared to receive data deletion requests from Users. _Note: See [Topic 48](./annex-2.02-high-level-requirements-by-topic.md#a2327-topic-48---blueprint-for-requesting-data-deletion-to-relying-parties) for more information about data deletion requests._ |      **Modify** by adding missing word        | Kukrule tuginevale isikule väljastatud registreerimissertifikaadi sisu PEAB **sisaldama** vähemalt üht järgmistest: a) kukrule tugineva isiku poolt pakutava veebivormi URL-i, mida kukrukasutajad saavad kasutada andmete kustutamise taotluste saatmiseks, b) kukrule tugineva isiku e-posti aadressi, millel kukrule tuginev isik on valmis kukrukasutajatelt andmete kustutamise taotlusi vastu võtma, c) kukrule tugineva isiku telefoninumbrit, millel kukrule tuginev isik on valmis kukrukasutajatelt andmete kustutamise taotlusi vastu võtma. _Märkus: Lisateavet andmete kustutamise taotluste kohta vt [Topic 48](./annex-2.02-high-level-requirements-by-topic.md#a2327-topic-48---blueprint-for-requesting-data-deletion-to-relying-parties)._ |
| RPRC_12 | The contents of a registration certificate issued to a Relying Party SHALL contain the name and country of the Data Protection Authority supervising the Relying Party. In addition, the registration certificate SHALL contain at least one of the following: a) the URL of a web form provided by the DPA, which Users can use to report suspicious attribute presentation requests. c) an e-mail address of the DPA, on which the DPA is prepared to receive reports about suspicious attribute presentation requests from Users, c) a telephone number of the DPA, on which the DPA is prepared to receive reports about suspicious attribute presentation requests from Users. _Note: See [Topic 50](./annex-2.02-high-level-requirements-by-topic.md#a2328-topic-50---blueprint-to-report-unlawful-or-suspicious-request-of-data) for more information about reporting suspicious attribute presentation requests._ |      Keep        | Kukrule tuginevale isikule väljastatud registreerimissertifikaadi sisu PEAB sisaldama kukrule tuginevat isikut teostava andmekaitseasutuse (DPA) nime ja riiki. Lisaks PEAB registreerimissertifikaat sisaldama vähemalt üht järgmistest: a) andmekaitseasutuse pakutava veebivormi URL-i, mida kukrukasutajad saavad kasutada kahtlastest atribuutide esitamise taotlustest teatamiseks. b) andmekaitseasutuse e-posti aadressi, millel andmekaitseasutus on valmis kukrukasutajatelt kahtlaste atribuutide esitamise taotluste kohta teateid vastu võtma, c) andmekaitseasutuse telefoninumbrit, millel andmekaitseasutus on valmis kukrukasutajatelt kahtlaste atribuutide esitamise taotluste kohta teateid vastu võtma. _Märkus: Lisateavet kahtlastest atribuutide esitamise taotlustest teatamise kohta vt [Topic 50](./annex-2.02-high-level-requirements-by-topic.md#a2328-topic-50---blueprint-to-report-unlawful-or-suspicious-request-of-data)._ |

##### C. Requirements on the issuance of registration certificates to PID Providers and Attestation Providers

| **Index** | **Requirement specification** |**Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPRC_13 | A Registrar MAY decide that, during the registration process for PID Providers, QEAA Providers, PuB-EAA Provider, or non-qualified EAA Providers, as specified in [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), a Provider of registration certificates associated to the Member State Registrar must create and sign or seal ~~a registration certificate~~ **one or more registration certificates. If the Registrar decides to do so, the Provider of registration certificates SHALL sign or seal a separate registration certificate for each of the registered services of the registering entity** and issue it to the registering entity. ~~If so,~~**Each** ~~that~~ registration certificate SHALL comply with the requirements in the technical specification mentioned in RPRC_0~~2~~**1**. |  Change to take into account registered services, and to correct reference   | Registripidaja VÕIB otsustada, et PID-i pakkujate, QEAA pakkujate, PuB-EAA pakkujate või mittekvalifitseeritud EAA pakkujate registreerimisprotsessi käigus, nagu on määratletud dokumendis [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), peab liikmesriigi registripidajaga seotud registreerimissertifikaatide pakkuja looma ja allkirjastama või pitseerima **ühe või mitu registreerimissertifikaati. Kui registripidaja nii otsustab, PEAB registreerimissertifikaatide pakkuja allkirjastama või pitseerima eraldi registreerimissertifikaadi iga registreeriva üksuse registreeritud teenuse kohta** ning väljastama selle registreerivale üksusele. **Iga** registreerimissertifikaat PEAB vastama punktis RPRC_01 mainitud tehnilises spetsifikatsioonis esitatud nõuetele. |
| RPRC_14 | If, during registration, a PID Provider, QEAA Provider, PuB-EAA Provider, or non-qualified EAA Provider received a registration certificate, it SHALL distribute it to all ~~its~~ service supply points **having an access certificate containing the same Relying Party Service identifier**. **_Notes: a) A service supply point is a system at which a Wallet Unit can start the process of requesting and obtaining a PID or attestation.**_ |     **Modify** to take Relying Party services into consideration.     | Kui PID-i pakkuja, QEAA pakkuja, PuB-EAA pakkuja või mittekvalifitseeritud EAA pakkuja sai registreerimise käigus registreerimissertifikaadi, PEAB ta selle jaotama kõigile teenuse pakkumise punktidele**, millel on juurdepääsusertifikaat, mis sisaldab sama kukrule tugineva isiku teenuse identifikaatorit**. **_Märkused: a) Teenuse pakkumise punkt on süsteem, kus kukrukomplekt saab alustada PID-i või atesteeringu taotlemise ja saamise protsessi._** |
| RPRC_15 | The contents of a registration certificate issued to a PID Provider, a QEAA Provider, a PuB-EAA Provider, or a non-qualified EAA Provider SHALL contain the type(s) of attestation that **the applicable service of** this entity intends to issue to Wallet Units, as registered per Reg_10e. |      Keep        | PID-i pakkujale, QEAA pakkujale, PuB-EAA pakkujale või mittekvalifitseeritud EAA pakkujale väljastatud registreerimissertifikaadi sisu PEAB sisaldama atesteerimise tüüpi (tüüpe), mida selle üksuse **kohaldatav teenus** kavatseb kukrukomplektidele väljastada, nagu on registreeritud vastavalt punktile Reg_10e. |

##### D. Requirements on the presentation and verification of registration certificates of Relying Parties

| **Index** | **Requirement specification** |**Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPRC_16 | Either after receiving a presentation request or as a general User setting, a Wallet Unit SHALL offer the User the possibility to indicate whether the User wants to verify the information registered by the competent Registrar about the Relying Party **and the Relying Party Service** the User is interacting with. |      **Modify**        | Kas pärast esitamistaotluse saamist või üldise kukrukasutajaseadena PEAB kukrukomplekt pakkuma kukrukasutajale võimalust näidata, kas kukrukasutaja soovib kontrollida pädeva registripidaja poolt registreeritud teavet kukrule tugineva isiku **ja kukrule tugineva isiku teenuse kohta**, kellega kukrukasutaja suhtleb. |
| RPRC_17 | If the User indicated that they want to verify the information registered about the Relying Party **and the Relying Party Service** and the Relying Party sent a registration certificate to the Wallet Unit, the Wallet Unit SHALL verify the authenticity and validity of the registration certificate according to the technical specification meant in RPRC_02. If the outcome of the verification is negative, the Wallet Unit SHALL, when asking for User approval according to RPA_07, notify the User that it could not obtain the information registered about the ~~entity~~**the Relying Party and the Relying Party Service**. |      **Modify**       | Kui kukrukasutaja märkis, et ta soovib kontrollida kukrule tugineva isiku **ja kukrule tugineva isiku teenuse kohta** registreeritud teavet ning kukrule tuginev isik saatis kukrukomplektile registreerimissertifikaadi, PEAB kukrukomplekt kontrollima registreerimissertifikaadi autentsust ja kehtivust vastavalt punktis RPRC_02 nimetatud tehnilisele spetsifikatsioonile. Kui kontrolli tulemus on negatiivne, PEAB kukrukomplekt kukrukasutajalt vastavalt punktile RPA_07 heakskiitu küsides teavitama kukrukasutajat, et ta ei saanud hankida **kukrule tugineva isiku ja kukrule tugineva isiku teenuse kohta** registreeritud teavet. |
| RPRC_18 | If the User indicated that they want to verify the information registered about the Relying Party **and the Relying Party Service**, but the Relying Party did not send a registration certificate to the Wallet Unit, the Wallet Unit SHALL connect to the URL of the online service of the Registrar to obtain this information. If the Wallet Unit cannot connect to this URL or if it cannot verify the authenticity and validity of the registered information, it SHALL, when asking for User approval according to RPA_07, notify the User that it could not obtain the information registered about the Relying Party **and the Relying Party Service**. _Note: The URL of the Registrar is included in the extension of the presentation request, see RPRC_19a._ |      **Modify**        | Kui kukrukasutaja märkis, et ta soovib kontrollida kukrule tugineva isiku **ja kukrule tugineva isiku teenuse kohta** registreeritud teavet, kuid kukrule tuginev isik ei saatnud kukrukomplektile registreerimissertifikaati, PEAB kukrukomplekt selle teabe saamiseks looma ühenduse registripidaja veebiteenuse URL-iga. Kui kukrukomplekt ei saa selle URL-iga ühendust luua või kui ta ei saa kontrollida registreeritud teabe autentsust ja kehtivust, PEAB ta kukrukasutajalt vastavalt punktile RPA_07 heakskiitu küsides teavitama kukrukasutajat, et ta ei saanud hankida kukrule tugineva isiku **ja kukrule tugineva isiku teenuse kohta** registreeritud teavet. _Märkus: Registripidaja URL sisaldub esitamistaotluse laienduses, vt RPRC_19a._ |
| RPRC_19 | If a Relying Party Instance received one or more registration certificates (see RPRC_10), it SHALL include a single registration certificate applicable for its current **Service and** intended use in each presentation request to a Wallet Unit, according to the applicable standard's extension mentioned in RPRC_20. The registration certificate SHALL be included in the request by value, not by reference. The Relying Party Instance SHALL do so both in proximity and remote presentation flows. _Notes: **a)** This ensures that no external requests are necessary to validate the Relying Party. **b) An RPI may be used for multiple Relying Party services, provided it has a separate access certificate for each of these services, see RPA_06 and Reg_10b.**_ |      **Modify**        | Kui tugineva osapoole instants sai ühe või mitu registreerimissertifikaati (vt RPRC_10), PEAB ta igasse kukrukomplektile esitatavasse esitamistaotlusse kaasama ühe registreerimissertifikaadi, mis on kohaldatav tema praegusele **teenusele ja** kavandatud kasutusotstarbele, vastavalt punktis RPRC_20 mainitud kohaldatava standardi laiendusele. Registreerimissertifikaat PEAB olema päringusse kaasatud väärtusena, mitte viitena. Tugineva osapoole instants PEAB seda tegema nii lähi- kui ka kaugveebi esitamise voogudes. _Märkused: **a)** See tagab, et kukrule tugineva isiku valideerimiseks ei ole vaja väliseid päringuid. **b) RPI-d võib kasutada mitme kukrule tugineva isiku teenuse jaoks, tingimusel et tal on iga sellise teenuse jaoks eraldi juurdepääsusertifikaat, vt RPA_06 ja Reg_10b.**_ |
| RPRC_19a | A Relying Party Instance SHALL include in each presentation request the following information, according to the applicable standard's extension mentioned in RPRC_20a: a) the ~~user-friendly~~ **trade** name of the Relying Party, b) the unique identifier of the Relying Party, **c)the trade name of the Relying Party Service, d) the identifier of the Relying Party Service,** e) a User-friendly description of the intended use of the ~~Relying Party~~ **current use case**, f) the URL of the Registrar of the Relying Party, and g) the identifier of the intended use of ~~the Relying Party~~**this use case**. _Notes: **a)** Including items a) and ~~b~~**c**) enables the Wallet Unit to show to the User the name of the Relying Party **and Relying Party Service**. Including ~~c~~**e**) enables the Wallet Unit to inform the User about the intended use. Including ~~c) and d)~~**b), d) and g)** enables the Wallet Unit, if desired by the User, to request from the Registrar the attributes registered by the Relying Party for this **Service and** intended use, as well as the corresponding privacy policy and other registered information. See [Technical Specification 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md) for the definition of this information. **b)** ~~Note that~~ in case the Relying Party Instance is operated by an intermediary, items a) - g) pertain to the intermediated Relying Party, see also RPI_06._ |      **Modify**        | Tugineva osapoole instants PEAB igasse esitamistaotlusse kaasama järgmise teabe vastavalt punktis RPRC_20a mainitud kohaldatava standardi laiendusele: a) kukrule tugineva isiku **ärinimi**, b) kukrule tugineva isiku unikaalne identifikaator, **c) kukrule tugineva isiku teenuse ärinimi, d) kukrule tugineva isiku teenuse identifikaator,** e) **praeguse kasutusjuhu** kavandatud kasutusotstarbe kasutajasõbralik kirjeldus, f) kukrule tugineva isiku registripidaja URL ja g) **selle kasutusjuhu** kavandatud kasutusotstarbe identifikaator. _Märkused: **a)** Punktide a) ja **c**) kaasamine võimaldab kukrukomplektil näidata kukrukasutajale kukrule tugineva isiku **ja kukrule tugineva isiku teenuse** nime. Punkti **e**) kaasamine võimaldab kukrukomplektil teavitada kukrukasutajat kavandatud kasutusotstarbest. Punktide **b), d) ja g)** kaasamine võimaldab kukrukomplektil, kui kukrukasutaja seda soovib, taotleda registripidajalt kukrule tugineva isiku poolt selle **teenuse ja** kavandatud kasutusotstarbe jaoks registreeritud atribuute, samuti vastavat privaatsuspoliitikat ja muud registreeritud teavet. Selle teabe määratluse kohta vt [Tehniline spetsifikatsioon 5](../../technical-specifications/ts5-common-formats-and-api-for-rp-registration-information.md). **b)** Juhul kui tugineva osapoole instantsi käitab vahendaja, on punktid a)–g) seotud vahendatava kukrule tugineva isikuga, vt ka RPI_06._ |
| RPRC_20 | Relying Party Instances and Wallet Units SHALL support the extension for [ISO/IEC 18013-5] or the extension for [OpenID4VP], as specified in ETSI TS 119 472-2 and amended by a CIR in preparation, as applicable, for transferring a single Relying Party registration certificate from a Relying Party Instance to a Wallet Unit. _Note: The correct CIR will be referenced here when it is published._ |      Keep        | Tugineva osapoole instantsid ja kukrukomplektid PEAVAD toetama standardi [ISO/IEC 18013-5] laiendust või standardi [OpenID4VP] laiendust, nagu on määratletud standardis ETSI TS 119 472-2 ja muudetud ettevalmistatava CIR-iga, vastavalt vajadusele, et edastada üks kukrule tugineva isiku registreerimissertifikaat tugineva osapoole instantsilt kukrukomplektile. _Märkus: Õigele CIR-ile viidatakse siin pärast selle avaldamist._ |
| RPRC_20a | Relying Party Instances and Wallet Units SHALL support the extension for [ISO/IEC 18013-5] or the extension for [OpenID4VP], as specified in ETSI TS 119 472-2 and amended by a CIR in preparation, as applicable, for transferring the information listed in RPRC_19a from a Relying Party Instance to a Wallet Unit. _Note: The correct CIR will be referenced here when it is published._ |      Keep        | Tugineva osapoole instantsid ja kukrukomplektid PEAVAD toetama standardi [ISO/IEC 18013-5] laiendust või standardi [OpenID4VP] laiendust, nagu on määratletud standardis ETSI TS 119 472-2 ja muudetud ettevalmistatava CIR-iga, vastavalt vajadusele, et edastada punktis RPRC_19a loetletud teave tugineva osapoole instantsilt kukrukomplektile. _Märkus: Õigele CIR-ile viidatakse siin pärast selle avaldamist._ |
| RPRC_21 | If the User indicated that they want to verify the information registered about a Relying Party and the Wallet Unit retrieved this information either from the registration certificate or from the online service of the Registrar (see RPRC_16 - RPRC_18), it SHALL verify that all attributes requested in the presentation request are included in the list of attributes registered by the Registrar. If the outcome of the verification is negative, the Wallet Unit SHALL, when asking for User approval according to RPA_07, notify the User about the requested attributes that the Relying Party did not register. |      Keep        | Kui kukrukasutaja märkis, et ta soovib kontrollida kukrule tugineva isiku kohta registreeritud teavet ja kukrukomplekt hankis selle teabe kas registreerimissertifikaadist või registripidaja veebiteenusest (vt RPRC_16 - RPRC_18), PEAB ta kontrollima, et kõik esitamistaotluses taotletud atribuudid sisalduvad registripidaja poolt registreeritud atribuutide loendis. Kui kontrolli tulemus on negatiivne, PEAB kukrukomplekt kukrukasutajalt vastavalt punktile RPA_07 heakskiitu küsides teavitama kukrukasutajat taotletud atribuutidest, mida kukrule tuginev isik ei registreerinud. |
...
| **Index** | **Requirement specification** |**Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPRC_22 | If a PID Provider or Attestation Provider received a registration certificate **for one of its services** (see RPRC_1**3**~~4~~), it SHALL include the **applicable** registration certificate in its Credential Issuer metadata used in the common OpenID4VCI protocol referenced in ISSU_01 and the extension thereof in ETSI TS 119 472-3. The registration certificate SHALL be included in the metadata by value, not by reference. _Note: This ensures that no external requests are necessary to validate the PID Provider or Attestation Provider, and that issuance transactions are atomic and self-contained._ |      **Modified**       | Kui PID-i pakkuja või atesteerimisteenuse pakkuja sai **ühe oma teenuse jaoks** registreerimissertifikaadi (vt RPRC_13), PEAB ta kaasama **kohaldatava** registreerimissertifikaadi oma tõendi väljastaja metaandmetesse, mida kasutatakse punktis ISSU_01 viidatud ühises OpenID4VCI protokollis ja selle laienduses standardis ETSI TS 119 472-3. Registreerimissertifikaat PEAB olema metaandmetesse kaasatud väärtusena, mitte viitena. _Märkus: See tagab, et PID-i pakkuja või atesteerimisteenuse pakkuja valideerimiseks ei ole vaja väliseid päringuid ning et väljastamistehingud on atomaarsed ja iseseisvad._ |
| RPRC_22a | A PID Provider or Attestation Provider SHALL include the ~~the~~ following information in its Credential Issuer metadata used in the common OpenID4VCI protocol referenced in ISSU_01 and the extension thereof in ETSI TS 119 472-3: a) the ~~user-friendly~~**trade** name of the PID Provider or Attestation Provider, b) the unique identifier of the PID Provider or Attestation Provider, **c)the trade name of the Relying Party Service, d) the identifier of the Relying Party Service,** e) a User-friendly description of the PID(s) or attestation(s) issued by this **Service of the** PID Provider or Attestation Provider, f) the URL of the Registrar of the PID Provider or Attestation Provider, and g) the attestation type(s) that **this Service of** the PID Provider or Attestation Provider intends to issue to Wallet Units. |      **Modified**       | PID-i pakkuja või atesteerimisteenuse pakkuja PEAB kaasama oma tõendi väljastaja metaandmetesse, mida kasutatakse punktis ISSU_01 viidatud ühises OpenID4VCI protokollis ja selle laienduses standardis ETSI TS 119 472-3, järgmise teabe: a) PID-i pakkuja või atesteerimisteenuse pakkuja **ärinimi**, b) PID-i pakkuja või atesteerimisteenuse pakkuja unikaalne identifikaator, **c) kukrule tugineva isiku teenuse ärinimi, d) kukrule tugineva isiku teenuse identifikaator,** e) selle PID-i pakkuja või atesteerimisteenuse pakkuja **teenuse** poolt väljastatava(te) PID(ide) või atesteeringu(te) kasutajasõbralik kirjeldus, f) PID-i pakkuja või atesteerimisteenuse pakkuja registripidaja URL ja g) atesteerimise tüüp (tüübid), mida **see** PID-i pakkuja või atesteerimisteenuse pakkuja **teenus** kavatseb kukrukomplektidele väljastada. |
| RPRC_23 | A Wallet Unit SHALL verify that the type of attestation it wants to request from the PID Provider or Attestation Provider is registered by the relevant Registrar, according to ISSU_24a for PID Providers and ISSU_34a for Attestation Providers. _Note: Unlike for Relying Parties, see RPRC_21, the Wallet Unit always carries out this verification, regardless of the preference of the User set as per RPRC_16._ |      Keep        | Kukrukomplekt PEAB kontrollima, et atesteerimise tüüp, mida ta soovib PID-i pakkujalt või atesteerimisteenuse pakkujalt taotleda, on registreeritud asjakohase registripidaja poolt, vastavalt punktile ISSU_24a PID-i pakkujate puhul ja punktile ISSU_34a atesteerimisteenuse pakkujate puhul. _Märkus: Erinevalt kukrule tuginevatest isikutest, vt RPRC_21, viib kukrukomplekt selle kontrolli alati läbi, olenemata kukrukasutaja eelistusest, mis on määratud vastavalt punktile RPRC_16._ |

### 4.4 Topic 52 - Relying Party Intermediaries

| **Index** | **Requirement specification** | **Proposal** | **Nõude spetsifikatsioon** |
|-----------|--------------------------------------------------------------|--------------|------------------------------|
| RPI_01 | An intermediary SHALL register as a Relying Party, in accordance with all requirements in [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), while indicating it intends to act as an intermediary. _Note: a) This implies that an intermediary obtains an access certificate containing its own name and unique Relying Party identifier. b) An intermediary may also obtain a registration certificate according to [Topic 44](./annex-2.02-high-level-requirements-by-topic.md#a2326-topic-44---registration-certificates-for-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), but this certificate will not be used for intermediated transactions. c) An entity that registered as an intermediary may also register as a Relying Party in its own capacity. In such a case, it will receive one or more registration certificates for its intended use(s), and will use one of these certificates when interacting with a Wallet Unit._ |      Keep        | Vahendaja PEAB registreeruma kukrule tuginevaks isikuks kooskõlas kõigi nõuetega dokumendis [Topic 27](./annex-2.02-high-level-requirements-by-topic.md#a2316-topic-27---registration-of-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), märkides samas, et ta kavatseb tegutseda vahendajana. _Märkus: a) See tähendab, et vahendaja saab juurdepääsusertifikaadi, mis sisaldab tema enda nime ja unikaalset kukrule tugineva isiku identifikaatorit. b) Vahendaja võib saada ka registreerimissertifikaadi vastavalt dokumendile [Topic 44](./annex-2.02-high-level-requirements-by-topic.md#a2326-topic-44---registration-certificates-for-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties), kuid seda sertifikaati ei kasutata vahendatud tehingute jaoks. c) Üksus, kes registreerus vahendajana, võib registreeruda ka kukrule tuginevaks isikuks omaenda pädevuses. Sellisel juhul saab ta ühe või mitu registreerimissertifikaati oma kavandatud kasutusotstarbe(te) jaoks ja kasutab üht neist sertifikaatidest kukrukomplektiga suheldes._ |
| RPI_02 | Empty |      -        | Tühi |
| RPI_03 | An intermediary SHALL register each intermediated Relying Party it is acting on behalf of at a Registrar in the Member State where the intermediated Relying Party is established, according all requirements in [Topic 44](./annex-2.02-high-level-requirements-by-topic.md#a2326-topic-44---registration-certificates-for-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties). If a Provider of registration certificates associated with the Registrar issues registration certificates, the intermediary SHALL receive a registration certificate for each of the registered intended uses of the intermediated Relying Party. |      Keep        | Vahendaja PEAB registreerima iga vahendatava kukrule tugineva isiku, kelle nimel ta tegutseb, registripidaja juures liikmesriigis, kus vahendatav kukrule tuginev isik asub, vastavalt kõigile nõuetele dokumendis [Topic 44](./annex-2.02-high-level-requirements-by-topic.md#a2326-topic-44---registration-certificates-for-pid-providers-providers-of-qeaas-pub-eaas-and-non-qualified-eaas-and-relying-parties). Kui registripidajaga seotud registreerimissertifikaatide pakkuja väljastab registreerimissertifikaate, PEAB vahendaja saama registreerimissertifikaadi vahendatava kukrule tugineva isiku iga registreeritud kavandatud kasutusotstarbe kohta. |
| RPI_04 | When registering an intermediated Relying Party, an intermediary SHALL provide legally valid evidence that this Relying Party will indeed use the services of this intermediary to interact with Wallet Units. The Registrar SHALL verify this evidence, and, if it is found to be correct, SHALL register the relationship between the intermediary and the intermediated Relying Party. _Note: Such evidence may, for instance, be a contract between the intermediary and the intermediated Relying Party._ |      Keep        | Vahendatava kukrule tugineva isiku registreerimisel PEAB vahendaja esitama õiguslikult kehtivad tõendid selle kohta, et see kukrule tuginev isik tõepoolest kasutab selle vahendaja teenuseid kukrukomplektidega suhtlemiseks. Registripidaja PEAB neid tõendeid kontrollima ja kui need leitakse olevat õiged, PEAB registreerima vahendaja ja vahendatava kukrule tugineva isiku vahelise suhte. _Märkus: Sellised tõendid võivad olla näiteks leping vahendaja ja vahendatava kukrule tugineva isiku vahel._ |
| RPI_05 | When an intermediated Relying Party asks its intermediary to request some attributes from a Wallet Unit, it SHALL specify a) its ~~user-friendly~~**trade** name, b) its unique identifier, **c) its Service identifier, d) the trade name of its Service, e**~~c~~) the URL of its Registrar. f) the identifier of its intended use, g) a User-friendly  description of its intended use. In addition, if the intermediated Relying Party has registration certificates, it SHALL indicate which single registration certificate the intermediary must include in the presentation request. _Note: a) See RPRC_19a for why the intermediary needs this information. b) Since a), b) and ~~c~~**e**) will not change for each request, specification of this information can be done once. The same is true for c) and d) if the intermediated Relying Party has only one registered **Service, and for f) and g) in case it has only one** intended use._ |    **Modify**    | Kui vahendatav kukrule tuginev isik palub oma vahendajal taotleda kukrukomplektilt teatud atribuute, PEAB ta täpsustama a) oma **ärinime**, b) oma unikaalse identifikaatori, **c) oma teenuse identifikaatori, d) oma teenuse ärinime, e**) oma registripidaja URL-i. f) oma kavandatud kasutusotstarbe identifikaatori, g) oma kavandatud kasutusotstarbe kasutajasõbraliku kirjelduse. Lisaks, kui vahendataval kukrule tugineval isikul on registreerimissertifikaate, PEAB ta märkima, millise ühe registreerimissertifikaadi vahendaja peab esitamistaotlusse kaasama. _Märkus: a) Vt RPRC_19a selle kohta, miks vahendaja seda teavet vajab. b) Kuna a), b) ja **e**) ei muutu iga päringu puhul, saab selle teabe määrata üks kord. Sama kehtib c) ja d) kohta, kui vahendataval kukrule tugineval isikul on ainult üks registreeritud **teenus, ning f) ja g) kohta, juhul kui tal on ainult üks** kavandatud kasutusotstarve._ |
| RPI_06 | When requested by an intermediated Relying Party, an intermediary SHALL request a presentation of attributes from a specific Wallet Unit. In the request, the intermediary SHALL include the intermediary's access certificate meant in requirement RPI_01 and the registration certificate of the Relying Party, as meant in RPI_03, if available. In addition, whether or not a registration certificate is available, the intermediary SHALL include in the request the information about the intermediated Relying Party required in RPRC_19a. |      Keep        | Vahendatava kukrule tugineva isiku taotlusel PEAB vahendaja taotlema konkreetselt kukrukomplektilt atribuutide esitamist. Päringusse PEAB vahendaja kaasama vahendaja juurdepääsusertifikaadi, nagu on mõeldud nõudes RPI_01, ja kukrule tugineva isiku registreerimissertifikaadi, nagu on mõeldud nõudes RPI_03, kui see on saadaval. Lisaks, olenemata sellest, kas registreerimissertifikaat on saadaval või mitte, PEAB vahendaja kaasama päringusse punktis RPRC_19a nõutud teabe vahendatava kukrule tugineva isiku kohta. |
| RPI_06a | Empty |      -        | Tühi |
| RPI_07 | In case a Wallet Unit receives a presentation request from an intermediary on behalf of an intermediated Relying Party, it SHALL display the **trade** names and identifiers of both the intermediary and the intermediated Relying Party to the User when asking for User approval, as described in RPA_07. _Note: In this case, the **trade** name and identifier of the intermediary are included in the access certificate presented by the Relying Party Instance, whereas the **trade** name and identifier of the intermediated Relying Party are included in the extension of the presentation request (see RPRC_19a), and in the registration certificate if available. If these names and identifiers are different, the Wallet Unit knows that the presentation request is from an intermediary on behalf of an intermediated Relying Party._ |    **Modify**    | Juhul kui kukrukomplekt saab vahendajalt esitamistaotluse vahendatava kukrule tugineva isiku nimel, PEAB ta kuvama kukrukasutajale nii vahendaja kui ka vahendatava kukrule tugineva isiku **ärinimed** ja identifikaatorid, kui ta küsib kukrukasutaja heakskiitu, nagu on kirjeldatud punktis RPA_07. _Märkus: Sellisel juhul sisalduvad vahendaja **ärinimi** ja identifikaator tugineva osapoole instantsi poolt esitatud juurdepääsusertifikaadis, samas kui vahendatava kukrule tugineva isiku **ärinimi** ja identifikaator sisalduvad esitamistaotluse laienduses (vt RPRC_19a) ja registreerimissertifikaadis, kui see on saadaval. Kui need nimed ja identifikaatorid on erinevad, teab kukrukomplekt, et esitamistaotlus pärineb vahendajalt vahendatava kukrule tugineva isiku nimel._ |
| RPI_07a | In case a Wallet Unit receives a presentation request from an intermediary on behalf of an intermediated Relying Party, and if the User indicated that they want to verify the information registered about this Relying Party (according to RPRC_16), the Wallet Unit SHALL verify that that the contractual relationship between the Relying Party **Service** and the intermediary **Service** is indeed registered by the responsible Registrar according to RPI_04, see also RPRC_04. If this verification fails, the Wallet Unit SHALL notify the User when asking for User consent. _Note: The Wallet Unit can either do this by inspecting the registration certificate (if available) or by querying the Registrar._ |      **Modify**        | Juhul kui kukrukomplekt saab vahendajalt esitamistaotluse vahendatava kukrule tugineva isiku nimel ja kui kukrukasutaja märkis, et ta soovib kontrollida selle kukrule tugineva isiku kohta registreeritud teavet (vastavalt punktile RPRC_16), PEAB kukrukomplekt kontrollima, et lepinguline suhe kukrule tugineva isiku **teenuse** ja vahendaja **teenuse** vahel on tõepoolest registreeritud vastutava registripidaja poolt vastavalt punktile RPI_04, vt ka RPRC_04. Kui see kontroll ebaõnnestub, PEAB kukrukomplekt kukrukasutajat teavitama, kui ta küsib kukrukasutaja nõusolekut. _Märkus: Kukrukomplekt võib seda teha kas registreerimissertifikaadi (kui see on saadaval) kontrollimise teel või registripidajalt pärides._ |
| RPI_07b | Empty |      -       | Tühi |
| RPI_08 | When a Wallet Unit presents to an intermediary any User attributes from a PID or attestation, the intermediary SHALL, after successfully carrying out the verifications in RPI_09, forward these attributes (only) to the Relying Party on behalf of which the presentation request was made. If any of the verifications in RPI_09 fail, the intermediary SHALL NOT forward any attributes to the Relying Party. |      Keep        | Kui kukrukomplekt esitab vahendajale mis tahes kukrukasutaja atribuute PID-ist või atesteeringust, PEAB vahendaja pärast punktis RPI_09 nimetatud kontrollide edukat läbiviimist edastama need atribuudid (ainult) kukrule tuginevale isikule, kelle nimel esitamistaotlus tehti. Kui mõni punktis RPI_09 nimetatud kontrollidest ebaõnnestub, EI TOHI vahendaja ühtegi atribuuti kukrule tuginevale isikule edastada. |
| RPI_09 | When a Wallet Unit presents to an intermediary any attributes from a PID or attestation, the intermediary SHALL verify the authenticity of the PID or attestation, its revocation status, device binding, and User binding, as well as any combined presentation of attributes, if applicable, as specified in this ARF and if agreed with the Relying Party. Furthermore, the intermediary SHALL verify the authenticity of the Wallet Unit and its revocation status, as specified in this ARF, if agreed with the Relying Party. _Note: ~~This~~**The** ARF does not mandate that a Relying Party must carry out all of these verifications. Therefore, the intermediary and any Relying Party using its services must agree on what verifications the intermediary will carry out._ |       **Modify**       | Kui kukrukomplekt esitab vahendajale mis tahes atribuute PID-ist või atesteeringust, PEAB vahendaja kontrollima PID-i või atesteeringu autentsust, selle tühistamise olekut, seadmega sidumist ja kukrukasutajaga sidumist, samuti atribuutide mis tahes kombineeritud esitamist, kui see on kohaldatav, nagu on määratletud käesolevas ARF-is ja kui see on kukrule tugineva isikuga kokku lepitud. Lisaks PEAB vahendaja kontrollima kukrukomplekti autentsust ja selle tühistamise olekut, nagu on määratletud käesolevas ARF-is, kui see on kukrule tugineva isikuga kokku lepitud. _Märkus: **See** ARF ei nõua, et kukrule tuginev isik peab kõik need kontrollid läbi viima. Seetõttu peavad vahendaja ja mis tahes tema teenuseid kasutav kukrule tuginev isik kokku leppima, milliseid kontrolle vahendaja läbi viib._ |
| RPI_10 | The intermediary SHALL delete any PIDs or attestations it obtained from the Wallet Unit, including any User attributes, completely and immediately after it has sent the User attributes to the intermediated Relying Party. If the intermediary does not send any User attributes to the intermediated Relying Party, for example because one of the verifications in the previous step failed, the intermediary SHALL delete the PIDs, attestations, or WUAs completely and immediately as soon as it has completed all necessary verifications. |      Keep        | Vahendaja PEAB kustutama kõik kukrukomplektilt saadud PID-id või atesteeringud, sealhulgas mis tahes kukrukasutaja atribuudid, täielikult ja viivitamata pärast seda, kui ta on saatnud kukrukasutaja atribuudid vahendatavale kukrule tuginevale isikule. Kui vahendaja ei saada ühtegi kukrukasutaja atribuuti vahendatavale kukrule tuginevale isikule, näiteks seetõttu, et üks eelmisel etapil tehtud kontrollidest ebaõnnestus, PEAB vahendaja kustutama PID-id, atesteeringud või WUA-d täielikult ja viivitamata kohe, kui ta on kõik vajalikud kontrollid lõpetanud. |
