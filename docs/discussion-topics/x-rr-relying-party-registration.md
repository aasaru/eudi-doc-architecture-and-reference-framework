...
| Reg_10e   | A PID Provider or Attestation Provider SHALL register which type(s) of attestation each of its registered services intends to issue to Wallet Units. | New - Note that this requirement must be included in TS5 / TS6. | PID-i pakkuja või atesteerimisteenuse pakkuja PEAB registreerima, millist tüüpi atesteeringuid iga tema registreeritud teenus kavatseb kukru üksustele väljastada. |
